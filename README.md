...
Installer больше не создаёт клиента по умолчанию и не зависит от доступности provider APIs во время установки. Первый клиент создаётся вручную в панели после входа. WB Stream и Telemost требуют ручной `room_id`: для Telemost вставь ссылку или ID комнаты Telemost.
